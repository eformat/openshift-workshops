...
`Be sure to use your own environment registry ip and image streams from`

[source]
----
oc get is -n development-user01
oc get is -n development-user01 --template='{{range .items}}{{.status.dockerImageRepository}}{{end}}'
----
