...
[source]
----
oc project helloservice-username
...
----
oc login -u admin
oc adm policy add-cluster-role-to-user cluster-reader system:serviceaccount:helloservice-username:metrics
----
...
System wide metrics deployments for general application performance monitoring is being worked on in the community.
