...
the login command and its configuration in the https://docs.openshift.com/container-platform/3.5/cli_reference/get_started_cli.html[OpenShift Documentation].
